...
const { BasePegaYourLibraryStarRatingInput } = composeStories(DemoStories);

test('renders PegaYourLibraryStarRatingInput', async () => {
  render(<BasePegaYourLibraryStarRatingInput />);
