...
const meta: Meta<typeof PegaExtensionsUtilityList> = {
  title: 'PegaExtensionsUtilityList',
...
export const BasePegaExtensionsUtilityList: Story = (args: any) => {
...
return (
    <>
      <PegaExtensionsUtilityList {...props} {...args} />
    </>
  );
};

BasePegaExtensionsUtilityList.args = {};
