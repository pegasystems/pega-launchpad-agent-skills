// @ts-nocheck
// Star Rating Input field component example used in the DXCB skill.
// This file mirrors the production implementation so developers can study and reuse it.
...
// Props are a combination of design-time config.json settings and runtime props from Constellation
