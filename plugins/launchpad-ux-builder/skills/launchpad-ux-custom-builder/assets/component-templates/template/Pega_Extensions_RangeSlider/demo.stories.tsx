...
import PegaYourLibraryRangeSlider from './index';
...
const meta: Meta<typeof PegaYourLibraryRangeSlider> = {
  title: 'PegaYourLibraryRangeSlider',
  component: PegaYourLibraryRangeSlider,
  excludeStories: /.*Data$/,
  parameters: {
    type: 'Details'
  }
...
export default meta;
type Story = StoryObj<typeof PegaYourLibraryRangeSlider>;
...
export const BasePegaYourLibraryRangeSlider: Story = (args: any) => {
  const props = {
    getPConnect: () => {
      return {
        getChildren: () => {
  ...
  return (
    <>
      <PegaYourLibraryRangeSlider {...props} {...args}>
        <Region
          {...{
            getPConnect: () => ({
              setInheritedProp: () => {},
        ...
        />
      </PegaYourLibraryRangeSlider>
    </>
  );
};

BasePegaYourLibraryRangeSlider.args = {
  showLabel: true,
